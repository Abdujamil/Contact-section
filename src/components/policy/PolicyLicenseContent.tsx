...
export default function PolicyLicenseContent() {
        ...
        >
          ...
          <div className="w-[624px] rounded-lg shadow-2xl">
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute top-[-70px] left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
        ...
        >
          <div className="oferta-content policy-content">
            ...
            <section id="pochemu-licenzii-vazhny" className="scroll-mt-[80px]">
              ...
              <ul className={`list-disc pl-[20px]`}>
                <li> используем только легально зарегистрированное ПО</li>
                <li>гарантируем защиту данных</li>
                <li>соблюдаем правовые нормы</li>
                <li>
                  имеем все необходимые документы для сотрудничества с
            ...
            <section id="poprobuyte-servis" className="scroll-mt-[80px]">
              ...
              <ul className={`list-disc pl-[20px]`}>
                <li> Распознавание аудио и видео до 30 минут</li>
                <li>Поддержка деловой терминологии и пунктуации</li>
                <li>Удобная работа в личном кабинете</li>
                <li>
                  Возможность выгрузки текстов в .TXT, .DOCX, .SRT и другие
                  форматы
                </li>
              </ul>
            </section>

    ...
    <div>
      ...
      >
        <div className="oferta-content policy-content">
          <section id="litsenzii-i-pravovoy-status">
            <h2>
            ...
            <p>
              Наша компания работает в сфере автоматической транскрибации аудио
              и видео в текст и уделяет особое внимание юридической
              прозрачности.
            </p>
            <p>
              Каждый клиент Audiosector может быть уверен: мы работаем легально,
              соблюдая все требования законодательства РФ и действуя
          ...
          <section id="svidetelstvo-o-registratsii">
          ...
          <section id="akkreditovannaya-it-kompaniya">
              ...
              <div className={`flex flex-col justify-between h-[380px]`}>
                <div>
                  ...
                  <ul className={`list-disc pl-[20px] mb-[20px]`}>
                    ...
                    <li>
                      Иных нормативных актов в области цифровых услуг и хранения
                      данных
                    </li>
                  </ul>
          ...
          <section id="pochemu-licenzii-vazhny">

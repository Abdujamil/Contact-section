...
import {handleMouseLeave, handleMouseMove, handleTabClick} from "@/components/Form/mouse";
        ...
        <div
            ...
            <div className="relative !w-[220px] !overflow-hidden">
                <button
                    ...
                    <span
                        className={`text-[20px] !transition-all !duration-[.15s] !ease-in !group-hover:text-[#ccc] ${activeTab === 'contact' ? "!text-[#3D9ED6]" : "#878787"}`}>
                                              Связаться
                                            </span>
                    <svg
            ...
            <div className="relative !w-[220px] !overflow-hidden">
                <button
                    ...
                    <span className={`text-[20px] !transition-all !duration-[.15s] !ease-in ${activeTab === 'requisite' ? "!text-[#3D9ED6]" : "#878787"}`}>
                                          Реквизиты
                                        </span>
                    <svg
                        className={`${styles.sendIconRight}  transition-all !duration-[.15s] ease-in`}

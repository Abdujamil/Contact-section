    ...
    return (
        <>
                ...
                <aside className="sticky top-20 h-fit z-[10] w-[260px]">
                    {showRegisterPromo && (
                        ...
                        >
                            ...
                            <CustomButton label="Получить" iconLeft={blogIcon} iconRight={blogIcon} className={`!w-[190px]`} />
                        </div>
                    )}
                        ...
                        >
                            <div className="relative w-full max-w-[260px] h-[51px] !overflow-hidden">
                                ...
                                >
                                    ...
                                    <span
                                        className="font-normal text-[20px] leading-[120%] !transition-all !duration-[.15s] !ease-in ">
                    Предыдущая
                  </span>
                                </button>
            ...
            <div className={`${styles.blogCardsContainer} h-auto w-full`}>
                <div
                    className={`${styles.blogCards} grid grid-cols-4 gap-[40px]`}
                >

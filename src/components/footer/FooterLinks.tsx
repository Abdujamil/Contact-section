...
//           {/* Кастомный select */}
//           <div className={`relative hidden md:block`} ref={selectRef}>
  ...
  return (
      <div className={`${styles.links} m-auto sm:m-0`}>
        ...
        <div className="block md:hidden">
          ...
          {copied && (
              <div className="fixed top-4 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-[#28262680] backdrop-blur-[20px] rounded-[4px] text-white text-sm px-3 py-1 animate-fade-in-out z-50">
                <Check className="w-4 h-4 text-green-400" />
                <span>Скопировано</span>
              </div>
          )}

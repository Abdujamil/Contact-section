...
export default function Breadcrumbs({
    ...
    return (
        <nav
            className="w-full absolute z-[999] font-[Roboto] !text-[12px] font-[250] md:!text-[16px] pt-[3px] top-[60px] md:pb-[3px] left-0 text-[#e1e1e1] md:mb-4 max-w-[100%] border-b border-b-[#FFFFFF19]">
            <div

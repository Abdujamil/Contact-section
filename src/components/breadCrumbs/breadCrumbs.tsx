...
export default function Breadcrumbs({
    ...
    return (
        <nav
            className="w-full absolute z-[999] font-[Rubik] !text-[12px] md:!text-[16px] pt-[10px] top-[60px] md:pb-[3px] left-0 text-[#adadad] md:mb-4 max-w-[100%] border-b border-b-[#FFFFFF19]">
            <div

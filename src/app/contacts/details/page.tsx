                ...
                <div className={`md:ml-[-1px]`}>
                    ...
                    <div className="md:w-[778px]">
                        ...
                        <div className="hidden grid-cols-1 md:grid-cols-2 gap-[30px] md:grid">
                            <svg width="374" height="1" viewBox="0 0 374 1" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <line x1="374" y1="0.5" y2="0.5" stroke="url(#paint0_linear_7308_5591)"/>
                                <defs>
                                    <linearGradient id="paint0_linear_7308_5591" x1="374" y1="-0.5" x2="0" y2="-0.5"
                            ...
                            <svg width="373" height="1" viewBox="0 0 373 1" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <line x1="-4.37114e-08" y1="0.5" x2="373" y2="0.499967"
                                      stroke="url(#paint0_linear_7308_5592)"/>
                                <defs>
                                    <linearGradient id="paint0_linear_7308_5592" x1="4.37114e-08" y1="1.5" x2="373"
                                                    y2="1.49997" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#353535"/>
                                        <stop offset="1" stopColor="#353535" stopOpacity="0"/>
                                    </linearGradient>
                                </defs>

...
import {validContact, emailRegex, phoneRegex} from '@/components/Form/validation';
...
export default function Contacts() {
    ...
    const {
        contactInputRef, selectRef, checkboxContainerRef, fileInputRef, textareaRef
    } = useFormRefs();
    ...
    const onSubmit = async (data: Record<string, unknown>) => {
        ...
        const isContactValid = isContactMethodSelected ? validContact(contactValue, isEmail, isPhone) : false;
                                        ...
                                        <form method="post" onSubmit={handleSubmit(onSubmit)}
                                            ...
                                            <div className="relative w-full max-w-[375px]">
                                                ...
                                                <input
                                                    ...
                                                    placeholder={text}
                                                    ref={fileInputRef}
                                                    onChange={(e) => handleFileUpload(e, setText, textareaRef)}
                                            ...
                                            <div className={`${styles.formInpts} w-full`}>
                                                ...
                                                >
                                                    ...
                                                    <AppInput
                                                        ...
                                                        onBlur={() => validContact(contactValue, isEmail, isPhone)}
                                                    />
                                                </div>

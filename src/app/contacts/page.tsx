          ...
          >
            ...
            >
              <div className={`${styles.contactLeftContent}`}>
                <h2
                  className={`${styles.txtGradientRight}  leading-[110%] text-[40px] font-normal mb-[33px] mt-[-5px]`}
                >
                  Контакты
                </h2>
                <Btns
              ...
              >
                ...
                <div className="mb-6">
                  <label className="pl-[18px] block text-lg font-light text-[#ccc] mb-2 leading-[110%]">
                    Юридический адрес
                  </label>
                  <input
                    type="text"

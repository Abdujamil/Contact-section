            ...
            <SmoothScroll>
                <div className={`min-h-screen mt-[129px]`}>
                    <div className={`max-w-[1180px] px-[10px] min-h-screen m-auto`}>
                        ...
                        >
                            <div
                                className="flex items-center gap-5 mb-[21px] md:mb-0 md:block min-w-[101px] min-h-[90px] rounded-[4px] overflow-hidden">
                                {currentEditor.avatar ? (
                                    <Image
                                        src={currentEditor.avatar}
                                        alt={currentEditor.name}
                        ...
                        <div className={``}>
                            ...
                            >
                                ...
                                <div
                                    className={`grid md:grid-cols-2 grid-cols-1 md:gap-[40px] gap-[20px] items-center`}>
                                    {editors
                                        .filter((editor) => editor.id !== currentEditor.id)
                                        .slice(0, 4)
                                        .map((editor) => (
                                            ...
                                            >
                                                <div
                                                    className=" flex items-center mb-[21px] md:mb-0 md:block gap-5 min-w-[101px] min-h-[90px] rounded-[4px] overflow-hidden">
                                                    {editor.avatar ? (
                                                        <Image
                                                            src={editor.avatar}
                                                            alt={editor.name}

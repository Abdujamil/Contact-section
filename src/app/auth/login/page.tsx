                    ...
                    <div
                        ...
                        <div className={`max-w-[280px] md:max-w-[374px] ml-[-1px] mb-[2px]`}>
                            ...
                            <div className={`mb-[-5px]`}>
                                ...
                                <div
                                    className="md:mt-[7px] mt-[2px] flex items-center justify-between md:gap-[2px] gap-[4px]">
                                ...
                                <div
                                    className="w-full mt-[4px]  flex flex-col md:flex-row items-center justify-between md:gap-[2px] gap-[4px]">

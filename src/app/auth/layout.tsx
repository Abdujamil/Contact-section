...
export default function AuthLayout({children}: { children: ReactNode }) {
    ...
    return (
        <>
            <Bg/>
            <div
                className={`${styles.politic} mt-[30px] h-full w-full max-w-[1180px] px-[10px] m-auto flex justify-center items-center`}
            >
                <div className="w-full md:grid md:max-h-[589px] gap-[40px] grid-cols-[260px_1fr]">
                    ...
                    <div
                        className={`${styles.BlogPageContent} h-full text-[18px] leading-relaxed whitespace-pre-line p-[30px] border border-[#353535] rounded-[6px]`}
                    >
                        {children}
                    </div>
                </div>

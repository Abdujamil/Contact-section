...
export default function Home() {
    ...
    const handleTabChange = (tab: 'contact' | 'requisite') => {
        setactiveTab(tab);
        // Увеличим задержку и добавим проверку видимости блока
        setTimeout(() => {
                                ...
                                <div
                                    ...
                                    <div className="relative w-full !overflow-hidden">
                                        ...
                                        >
                                            ...
                                            <span
                                                className="text-[20px] !transition-all !duration-200 !ease-in !group-hover:text-[#ccc]">
                                          Связаться
                                        </span>
                                            <svg
                                    ...
                                    <div className="relative w-full !overflow-hidden">
                                        ...
                                        >
                                            ...
                                            <span className="text-[20px] !transition-all !duration-200 !ease-in">
                                          Реквизиты
                                        </span>
                                            <svg
                                            ...
                                            <div className={`${styles.formInpts} w-full`}>
                                                ...
                                                <div className="relative w-full !max-w-[212px] !overflow-hidden">
                                                    ...
                                                    >
                                                        ...
                                                        <span
                                                            className="!transition-all !duration-200 !ease-in font-normal text-[18px] leading-[120%]">
                                                              Отправить
                                                            </span>
                                                        <svg
                                                            className={`${styles.sendIconRight}  transition-all duration-200 ease-in`}

                            ...
                            <div className={`${styles.contactLeftContent}`}>
                                ...
                                <div
                                    ...
                                    <div className="relative w-full">
                                        ...
                                        cursor-pointer w-full !h-[51px] !rounded-[4px] group flex items-center !justify-between !overflow-hidden`}
                                            style={{
                                                color: activeTab === 'contact' ? "#3D9ED6" : "#878787",
                                                border: activeTab === 'contact' ? "1px solid rgb(204 204 204 / 70%)" : "1px solid #353535",
                                            }}
                                        >
                                            <svg
                                            ...
                                            <span
                                                className="!transition-all !duration-200 !ease-in !group-hover:text-[#ccc]">
                                          Связаться
                                        </span>
                                            <svg
                                    ...
                                    <div className="relative w-full">
                                        <button
                                            ...
                                            className={`${styles["btn"]} ${HeaderStyles["login-button"]} cursor-pointer w-full !h-[51px] !rounded-[4px] group flex items-center !justify-between !overflow-hidden`}
                                            style={{
                                                color: activeTab === 'requisite' ? "#3D9ED6" : "#878787",
                                                border: activeTab === 'requisite' ? "1px solid rgb(204 204 204 / 70%)" : "1px solid #353535",
                                            }}
                                        >
                                            <svg
                                    ...
                                    {/*<GlassButton onClick={() => handleTabChange('contact')}*/}
                                    ...
                                    {/*<GlassButton className={`${styles.secGlassBtn} hover:bottom hover:border-[#ccc]`}*/}
                                    {/*             onClick={() => handleTabChange('requisite')}*/}
                                    {/*             isActive={activeTab === 'requisite'}>*/}
                        ...
                        `}>
                                    ...
                                    >
                                            ...
                                            <div className={`${styles.formInpts} w-full`}>
                                                ...
                                                <div className="relative w-full">
                                                    <button
                                                        type="submit"
                                                        className={`${styles.btn} ${HeaderStyles["login-button"]}  group  w-full !max-w-[212px] !h-[51px] px-[15px] py-[13px] mt-[50px] flex items-center !justify-between bg-[rgba(42,42,42,0.1)] rounded-[4px] backdrop-blur-[2px] border border-[#353535] hover:border-[#ccc] cursor-pointer text-[#ccc] font-normal text-[20px] relative !overflow-hidden transition-all duration-200 ease-in`}
                            ...
                            <div id="requisite-block"
                                ...
                                <div className="flex justify-between items-end  mb-5">
                                    ...
                                    {/*<button*/}
                                    {/*    className={`${styles.btn} ${HeaderStyles["login-button"]} flex items-center justify-center max-h-[51px] w-full max-w-[212px] gap-2 px-4 py-2 cursor-pointer bg-[rgba(42, 42, 42, 0.1)] backdrop-blur-[2px] border border-[#353535] rounded-[4px] text-[#CCCCCC] hover:text-white hover:bg-[rgba(42,42,42,0.5)] overflow-hidden transition-all duration-200 ease-in text-[20px]`}>*/}
                                    {/*    <Image*/}
                                    {/*        className={`${styles.sendIconLeft}  transition-all duration-200 ease-in`}*/}
                                    {/*        src='/pdf.png'*/}
                                    {/*        width={26}*/}

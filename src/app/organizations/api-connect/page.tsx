                ...
                >
                    <div className="oferta-content policy-content">
                        <section id="introduction">
                            <h2>Введение</h2>
                            <p>
                                Инструкция представляет возможности REST API для системы преобразования аудиозаписей в
                                текст с использованием запросов через интернет. Она поможет подключиться к API
                                AudioSector и автоматически расшифровывать аудиофайлы в текстовый формат. Это
                                руководство ориентировано на разработчиков, интеграторов, создателей CRM-систем,
                                маркетплейсов и других сервисных платформ.
                            </p>
                        </section>
                        <section id="workflow">
                            ...
                            <p>Для начала работы необходимо зарегистрироваться на сайте https://audiosector.ru Затем в
                                личном кабинете (ЛК) зайти в профиль и получить API-токен для авторизации запросов.
                                Токен

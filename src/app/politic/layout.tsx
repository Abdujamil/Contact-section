...
export default function OrganizationsLayout({children}: { children: ReactNode }) {
    ...
    const currentBlogItem = policyData[currentIndex]; // важно, чтобы индексы совпадали
